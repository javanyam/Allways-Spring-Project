...
public class customerOrderDto {
	...
	public customerOrderDto(int ordersId, int cakeId, int ordersSalePrice, int ordersQuantity, String cakeName) {
		super();
	...
	public customerOrderDto(String customerName, String customerPhone, String customerEmail,
	...
	public customerOrderDto(int ordersSalePrice, int ordersQuantity) {
		super();
		this.ordersSalePrice = ordersSalePrice;
		this.ordersQuantity = ordersQuantity;
	}

	public customerOrderDto(int ordersId) {
		super();
		this.ordersId = ordersId;
	}
